    ...
    <>
          ...
          <div className="hero-form">
            ...
            <form onSubmit={(e) => handleSubmit(e, 'Application Submitted')}>
              ...
              <button type="submit" className="btn btn-primary btn-submit-hero">
                Submit Application <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"><path d="M5 12h14M12 5l7 7-7 7"/></svg>
              </button>
            </form>
          </div>
        </div>
        <div className="scroll-hint">Scroll<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 5v14M5 12l7 7 7-7"/></svg></div>
      </section>
      ...
      <section className="how-it-works" id="how">
        ...
        <div className="steps-grid">
          <div className="step-card reveal"><div className="step-num">01</div><h3>Player Assessment</h3><p>We review your highlight videos, stats, academic record, and goals to build a complete player profile that stands out to coaches.</p></div>
          <div className="step-card reveal"><div className="step-num">02</div><h3>Program Matching</h3><p>Using our network of 1000+ schools, we match your talent and academic profile with the right programs and scholarship opportunities.</p></div>
          <div className="step-card reveal"><div className="step-num">03</div><h3>Scholarship &amp; Enrollment</h3><p>We guide you through applications, coach communications, campus visits, and scholarship negotiations until you sign.</p></div>
        </div>
      </section>
      ...
      <section className="contact-section" id="contact">
        ...
        <div className="contact-wrapper">
          <div className="contact-detail-row reveal">
            <div className="contact-detail"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z" /><polyline points="22,6 12,13 2,6" /></svg><a href="mailto:soccerbridgeusa@gmail.com">soccerbridgeusa@gmail.com</a></div>
            ...
            <div className="contact-detail"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M22.54 6.42a2.78 2.78 0 00-1.94-2C18.88 4 12 4 12 4s-6.88 0-8.6.46a2.78 2.78 0 00-1.94 2A29 29 0 001 12a29 29 0 00.46 5.58 2.78 2.78 0 001.94 2C5.12 20 12 20 12 20s6.88 0 8.6-.46a2.78 2.78 0 001.94-2A29 29 0 0023 12a29 29 0 00-.46-5.58z" /><polygon points="9.75 15.02 15.5 12 9.75 8.98 9.75 15.02" /></svg><a href="https://youtube.com/@soccerbridgeusa" target="_blank" rel="noreferrer">@soccerbridgeusa</a></div>
          </div>
      ...
      <footer>
        <a href="#" className="nav-logo"><img src={logo} alt="Soccer Bridge USA" /></a>
        <p>&copy; 2026 Soccer Bridge USA. All rights reserved.</p>
        <div className="social-links">
          <a href="https://instagram.com/thesoccerbridge" target="_blank" rel="noreferrer" aria-label="Instagram"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="2" width="20" height="20" rx="5" /><path d="M16 11.37A4 4 0 1112.63 8 4 4 0 0116 11.37z" /><line x1="17.5" y1="6.5" x2="17.51" y2="6.5" /></svg></a>
          <a href="https://youtube.com/@soccerbridgeusa" target="_blank" rel="noreferrer" aria-label="YouTube"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M22.54 6.42a2.78 2.78 0 00-1.94-2C18.88 4 12 4 12 4s-6.88 0-8.6.46a2.78 2.78 0 00-1.94 2A29 29 0 001 12a29 29 0 00.46 5.58 2.78 2.78 0 001.94 2C5.12 20 12 20 12 20s6.88 0 8.6-.46a2.78 2.78 0 001.94-2A29 29 0 0023 12a29 29 0 00-.46-5.58z" /><polygon points="9.75 15.02 15.5 12 9.75 8.98 9.75 15.02" /></svg></a>
          <a href="mailto:soccerbridgeusa@gmail.com" aria-label="Email"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z" /><polyline points="22,6 12,13 2,6" /></svg></a>
        </div>
      </footer>
    </>
  )
